<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm1.aspx.cs" Inherits="WebPages.Dashboard.Admin.WebForm1" %>
...
<head>
    ...
    <%--<script src="../JavaScript/tinymce.min.js"></script>--%>
    <script src="../JavaScript/JavaScript.js"></script>

    <script src="../JavaScript/jquery.ui.core.js"></script>
    <script src="../JavaScript/jquery.ui.datepicker-cc.js"></script>
    <script src="../JavaScript/calendar.js"></script>
    <script src="../JavaScript/jquery.ui.datepicker-cc-ar.js"></script>
    <script src="../JavaScript/jquery.ui.datepicker-cc-fa.js"></script>
    <script>
...
<body>
    ...
    <div id="print">
        <p class='ui-widget-header'>
            <input id="Button1" type="button" onclick="printModal('print');" value="button" />
            نمونه روشهای استفاده از پلاگین datepicker با تاریخ هجری شمسی<br />
            توسط: <a href='http://hasheminezhad.com'>مهدی هاشمی نژاد</a><br />
            ارایه نظرات و گزارش باگ: hasheminezhad at gmail dot com
        </p>
