<%@ Page Title="" Language="C#" MasterPageFile="~/Dashboard/Admin/AdminPanel.Master" AutoEventWireup="true" CodeBehind="reportsStudents.aspx.cs" Inherits="WebPages.Dashboard.Admin.reportsStudents" %>
    ...
    <div class="x_content">
            ...
            <div>
                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    <ContentTemplate>
                        ...
                        <asp:GridView ID="gvStudents" runat="server" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Horizontal" AutoGenerateColumns="False" CssClass="dirRight table" HorizontalAlign="Center" OnRowDataBound="gvStudents_RowDataBound" AllowCustomPaging="True" AllowPaging="True" OnRowCommand="gvStudents_RowCommand">
                            <Columns>
                                ...
                                <asp:BoundField DataField="FirstName" HeaderText="<%$ Resources:Dashboard,father_name%>" />
                                <asp:BoundField DataField="CGrade" HeaderText="مقطع" />
                                <asp:BoundField DataField="stuClass" HeaderText="شماره کلاس" />
        ...
        <div class="row">
            <div class="col-md-5 col-md-push-7 col-xs-6 col-xs-push-6">
                <button type="button" id="btnViewAll" class="btn btn-auto-h btn-info goRight" runat="server" style="margin-right: 5px;" onserverclick="btnViewAll_ServerClick">
