<%@ Page Title="" Language="C#" MasterPageFile="~/Dashboard/Admin/AdminPanel.Master" AutoEventWireup="true" CodeBehind="SessionDetails.aspx.cs" Inherits="WebPages.Dashboard.SessionDetails" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="c-title">
        <h4>
            ...
            <asp:Literal runat="server" Text="<%$ Resources:Dashboard,Details%>" />
        </h4>
    </div>
    <div class="c-content">
