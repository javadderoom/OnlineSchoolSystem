<%@ Page Title="" Language="C#" MasterPageFile="~/Dashboard/Teacher/TeacherPanel.Master" AutoEventWireup="true" CodeBehind="SessionDetails.aspx.cs" Inherits="WebPages.Dashboard.Teacher.SessionDetails" %>
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-2 text-right dirRight goLeft">
                            ...
                            <span runat="server" id="Span2" class="control-label formLabel" style="color: #0066CC; font-size: 100%; font-weight: bold;">
                                <asp:Literal runat="server" ID="tbxSessionDate" Text="" /></span>
                        </div>
                        <div class="col-xs-12 col-sm-2 text-right dirRight goLeft">
