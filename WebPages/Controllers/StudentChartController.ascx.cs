...
{
    public partial class StudentChartController : System.Web.UI.UserControl
    {
        public string stu = "93124345";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            studentsList = lgr.GetLessonsOfStudent(stu);
            studentsNames = lgr.GetLessonsOfStudent(stu);
            ...
            {
                ll = new List<decimal?>();
                ll = rep.GetAvgOfLessonsOFStudentPerMonth(studentsList[i]);
                datalist.Add(ll);
            }
            List<decimal?> l;
